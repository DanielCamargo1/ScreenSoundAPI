...
internal class LinqFiltros
{
    ...
    public static void ExibirResumodeUmaBanda(List<Musica> musicas, string banda)
    {
        var client = new OpenAIAPI("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");
        var chat = client.Chat.CreateConversation();
        chat.AppendSystemMessage($"Crie um resumo bem curto da banda {banda}");
        string res = chat.GetResponseFromChatbotAsync().GetAwaiter().GetResult();
